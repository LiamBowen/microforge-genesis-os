            ...
            <div className="hidden md:flex space-x-8">
              {navLinks.map((link) => (
                <Link 
                  key={link.path} 
                  to={link.path} 
                  className={`text-sm font-medium transition hover:text-neon-cyan relative ${
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`block px-3 py-2 rounded-md text-base font-medium ${
                    location.pathname === link.path ? "text-neon-cyan bg-dark-card" : "text-gray-300 hover:text-neon-cyan"
                  }`}
